...
fetch('data/questions.json')
    ...
    .then(data => {
        ...
        // Shuffle all questions and pick first 20
        const randomQuestions = shuffleArray(loadedQuestions).slice(0, MAX_QUESTIONS);

        questions = randomQuestions.map(loadedQuestion => {
            const formattedQuestion = {
                question: loadedQuestion.question
            };
        ...
        // Start the game after preparing the questions
        startGame(); 
    })
    .catch(err => {
